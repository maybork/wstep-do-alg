...
def search_in_wl(
    ...
    if query in wordlist:
        console.print(
            f":white_check_mark: Found [italic green]{query}[/italic green] in word list!"
        )
        return
    ...
    if matching_lens:
        console.print(
            f":white_question_mark: Didn't find your query, did you mean... [bold red]{', '.join(matching_lens[0:2])}[/bold red]?"
        )
    else:
        console.print(
            f":white_exclamation_mark: Didn't find your query or any similar words."
        )
